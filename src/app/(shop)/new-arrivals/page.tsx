...
import { getNewArrivals } from "@/lib/data/storefront";

export const revalidate = 60;

export default async function NewArrivalsPage() {
  const displayProducts = await getNewArrivals();
    ...
    <main className="min-h-screen bg-white">
      <div className="bg-gray-50 py-16 text-center border-b border-gray-100">
        ...
        <p className="mt-4 text-sm text-gray-500 max-w-lg mx-auto">
          Discover our latest drops. Fresh styles and new collections added recently.
        </p>
      </div>
